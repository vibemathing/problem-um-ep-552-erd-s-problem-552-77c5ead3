...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-552-erd-s-problem-552-77c5ead3-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-552"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-552-erd-s-problem-552-77c5ead3-v1",
      "problem_contract_sha256": "894d3ffebdf6da1a2997265a150243b10a80f36bccf7c2ebd38fd91e237db6f1",
      "problem_id": "problem:um-ep-552-erd-s-problem-552-77c5ead3",
      "route_id": "route:um-ep-552-erd-s-problem-552-77c5ead3-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-552-erd-s-problem-552-77c5ead3-source-fidelity-01",
      "graph_id": "graph:um-ep-552-erd-s-problem-552-77c5ead3-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-552-erd-s-problem-552-77c5ead3-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-552-erd-s-problem-552-77c5ead3-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Determine the Ramsey number $ R(C_4,S_n), $ where $S_n=K_{1,n}$ is the star on $n+1$ vertices. In particular, is it true that, for any $c>0$, there are infinitely many $n$ such that $ R(C_4,S_n)\\leq n+\\sqrt{n}-c? $"
          },
          "statement_sha256": "479a59e58f1600fa2190a4c111e1a16cbc30a1a2ff6f7dce6d822e01a42b8d98"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-552-erd-s-problem-552-77c5ead3-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-552-erd-s-problem-552-77c5ead3-root",
      "route_id": "route:um-ep-552-erd-s-problem-552-77c5ead3-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-552-c2d160a48740",
        "url": "https://www.unsolvedmath.com/problems/EP-552"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
